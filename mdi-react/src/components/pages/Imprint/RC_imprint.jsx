    ...
    <ColoredContainers h2Text="Imprint" h3Text="">
      <div className={styles["imprint-container"]}>
        ...
        <p>
          ...
          Text, images, graphics, sounds, animations and videos as well as their
          arrangement on the website are protected by copyright and other
          protective laws. The content of this website may not be copied,
          distributed, modified, or made accessible to thrid parties for
          commercial purposes.
        </p>
      </div>
    </ColoredContainers>
