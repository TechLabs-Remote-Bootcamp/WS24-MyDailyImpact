...
# Load impact data
scoring_df = pd.read_csv('meat-supply-per-person.csv')
...
df_co2 = pd.read_csv('greenhouse-gas-emissions-per-kilogram-of-food-product.csv', index_col='Entity')
df_land = pd.read_csv('land-use-per-kilogram-of-food-product.csv', index_col='Entity')
df_water = pd.read_csv('freshwater-withdrawals-per-kilogram-of-food-product.csv', index_col='Entity')
df_meat_type = pd.read_csv('per-capita-meat-type.csv')
population = pd.read_csv('population-per-country.csv', header=2)
